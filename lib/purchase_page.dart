...
class _PurchasesPageState extends State<PurchasesPage> {
  ...
  final List<String> allBrands = [   'Apple', 'Asus',  'BlackBerry', "Samsung", "Xiaomi","Google",
    "HMD", "Honor" , "Huawei", "Infinix", "Lava", "LG" , "Motorola" , "Nokia" , "Nothing" , "OnePlus"
    , "Oppo" ,"Realme" , "Tecno" , "Vertu" , "Vivo"
  ];
